...
class FileBird
{
    ...
    private function define_admin_hooks()
    {
        ...
        //Support Thrive
            ...
            $this->loader->add_action('tcb_main_frame_enqueue', $plugin_admin, 'enqueue_styles');
            $this->loader->add_action('tcb_main_frame_enqueue', $plugin_admin, 'enqueue_scripts');
            $this->loader->add_action('tcb_main_frame_enqueue', $plugin_admin, 'nt_upload');
    }
