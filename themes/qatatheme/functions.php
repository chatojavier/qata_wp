...
if ( ! function_exists( 'qatatheme_setup' ) ) :
	...
	function qatatheme_setup() {
		 ...
		 * If you're building a theme based on Qata Alpaca Theme, use a find and replace
		 * to change 'qatatheme' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'qatatheme' ),
			)
		);
...
function qatatheme_scripts() {
	...
	wp_enqueue_script( 'qatatheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
