...
<div class="header-slider">
            <div class="header-slider__carousel">
                <div class="swiper-wrapper">
                    <div class="swiper-slide header-slider__carousel__item bg-cover"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/responsibility_img_004.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/responsibility_img_004@2x.jpg" style="object-position: 0 0;"></img></div></a>
                    <div class="swiper-slide header-slider__carousel__item bg-cover"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/W-89.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/W-89@2x.jpg"></img></div></a>
                    <div class="swiper-slide header-slider__carousel__item bg-cover"><a href="about.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products_img_004.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/products_img_004@2x.jpg"></img></div></a>
                    <div class="swiper-slide header-slider__carousel__item bg-cover"><a href="about.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products_img_001.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/products_img_001@2x.jpg"></img></div></a>
                    <div class="swiper-slide header-slider__carousel__item bg-cover"><a href="about.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/products_img_003.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/products_img_003@2x.jpg"></img></div></a>
                </div>
            </div>
